...
import { idlFactory } from './landing_v2.did.js';
export { idlFactory } from './landing_v2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LANDING_V2;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./landing_v2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the landing_v2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./landing_v2.did.js")._SERVICE>}
 */
export const landing_v2 = createActor(canisterId);
