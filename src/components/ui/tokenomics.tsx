      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className={cn(
            ...
            <p className="text-white/60 text-[18px] px-6 xl:px-8">
              Lorem ipsum dolor sit amet consectetur. Lectus elit at euismod interdum.
            </p>
          </div>
        </div>
        ...
        <div className={cn(
          ...
          <p className={cn(
            ...
            Mattis sem tellus fames lectus arcu nec sit.
            Condimentum aliquet non convallis nulla et.
            Adipiscing et eget vivamus tellus massa consectetur nunc.
            Lobortis ullamcorper morbi iaculis volutpat.
          </p>
          <button className={cn(
