    ...
    >
      ...
      >
        ...
        <p className="text-white text-sm leading-[26px] max-w-[293px] md:text-base md:max-w-[354px] xl:max-w-3xl">
          Appic’s roadmap builds from an EVM-ICP bridge to a full cross-chain
          swap layer on ICP, targeting late 2025 completion. It includes
          ICP-to-EVM bridging, a Dex, and a swap router.
        </p>
      </div>
